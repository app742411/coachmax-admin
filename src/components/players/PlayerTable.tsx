              ...
              return (
                ...
                >
                  ...
                  <td className="py-4 px-3">
                    <span
                      className={`inline-flex items-center gap-1 font-bold ${status === "PAID" || status === "APPROVED" ? "text-emerald-600" : status === "UNPAID" || status === "REJECTED" ? "text-rose-600" : status === "TRIAL" ? "text-blue-500" : "text-amber-500"
                        }`}
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${status === "PAID" || status === "APPROVED" ? "bg-emerald-600" : status === "UNPAID" || status === "REJECTED" ? "bg-rose-600" : status === "TRIAL" ? "bg-blue-500" : "bg-amber-500"
                          }`}
                      />
                      {status}
                    </span>
