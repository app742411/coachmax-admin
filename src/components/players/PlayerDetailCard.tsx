        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide block mt-0.5">
              Jersey #{player.jerseyNumber} • {player.preferredFoot === "LEFT" ? "Left Foot" : "Right Foot"}
            </span>
          </div>
        </div>
        <button
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <span className="font-bold text-[#0047FF]">{player.programs?.[0]?.name || "N/A"}</span>
              </div>
              <div>
                <span className="text-slate-400 block mb-0.5">Program Class</span>
                <span className="font-semibold text-slate-800 dark:text-slate-200">
                  {player.group || "N/A"}
                </span>
              </div>
              <div className="col-span-2">
                <span className="text-slate-400 block mb-0.5">Club/Academy</span>
                <span className="font-semibold text-slate-800 dark:text-slate-200">
                  {player.currentClub || "N/A"}
                </span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              ...
              <div className="p-2.5 bg-slate-50 dark:bg-slate-800/40 rounded-xl">
                ...
                <span className="font-bold text-slate-800 dark:text-slate-200">{player.statistics.goals}</span>
              </div>
              <div className="p-2.5 bg-slate-50 dark:bg-slate-800/40 rounded-xl">
                <span className="text-[10px] text-slate-400 block mb-0.5">Current Season</span>
                <span className="font-bold text-slate-800 dark:text-slate-200">{player.statistics.matchesPlayed} matches</span>
              </div>
            </div>
          </div>
