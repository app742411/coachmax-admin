    ...
    <div className="bg-white border border-slate-100 dark:bg-slate-900 dark:border-slate-800 p-5 rounded-none shadow-theme-xs mb-6">
      <div className="flex flex-col md:flex-row md:items-center gap-4 justify-between mb-4">
        ...
        <div className="flex flex-wrap gap-2 text-xs">
          ...
          {/* <button className="flex items-center gap-1.5 px-3.5 py-2 border border-slate-200 rounded-none bg-slate-50 hover:bg-slate-100 font-semibold text-slate-600 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
            </svg>
            <span>More Filters</span>
          </button>
          <button className="flex items-center gap-1.5 px-4 py-2 rounded-none bg-[#0047FF] hover:bg-[#003cc2] font-semibold text-white transition-all shadow-theme-xs">
