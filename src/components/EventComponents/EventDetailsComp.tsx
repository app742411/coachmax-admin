         ...
         <div className="relative rounded-xl overflow-hidden bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm transition-all duration-500">
            ...
            <div className="h-64 md:h-80 w-full relative overflow-hidden group">
               ...
               <div className="absolute bottom-10 left-10 right-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                  <div className="space-y-3">
                     ...
                     <h1 className="text-4xl md:text-xl font-black italic uppercase text-white tracking-tighter leading-none">
                        {event.title}
                     </h1>
            ...
            <div className="p-10 grid grid-cols-1 lg:grid-cols-12 gap-12">
               ...
               <div className="lg:col-span-6 space-y-6">
                  <div className="p-8 bg-white dark:bg-gray-800/20 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm space-y-6">
               ...
               <div className="lg:col-span-6 space-y-6">
                  <div className="p-8 bg-brand-600 rounded-xl shadow-xl shadow-brand-500/20 text-white relative overflow-hidden group">
