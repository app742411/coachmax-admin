    ...
    try {
     ...
     if (event) {
      setFormData({
       ...
       registrationFee: event.registrationFee ? event.registrationFee.toString() : "",
      ...
      <div className="space-y-6">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
         ...
         <Select
          options={[{ value: "TOURNAMENT", label: "Tournament" }, { value: "LEAGUE", label: "League" }, { value: "CAMP", label: "Camp" }]}
          placeholder="Select Type"
          value={formData.eventType}
          onChange={(val: string) => setFormData(prev => ({ ...prev, eventType: val }))}
         />
        </div>
        <div>
        ...
        <div>
         ...
         <Input
          placeholder="e.g., BIRTH_CERTIFICATE,PHOTO"
        ...
        <div>
         ...
         <Input
          placeholder="e.g., London Youth Sports"
          name="organizer"
        ...
        <div className="col-span-1 md:col-span-2">
         ...
         <Input
          placeholder="e.g., Sponsor A,Sponsor B"
          name="sponsors"
      ...
      <div className="space-y-6">
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="col-span-2">
         ...
         <DatePicker
          defaultDate={formData.registrationDeadline || undefined}
