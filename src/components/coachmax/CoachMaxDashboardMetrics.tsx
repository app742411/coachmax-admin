 ...
 <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6 transition-all hover:scale-[1.02] shadow-sm">
  <div className="flex items-center justify-between gap-4">
   ...
   <div className="flex-1 text-right">
    <span className="text-xs font-bold text-gray-400 dark:text-gray-500 tracking-[0.1em]">
     {title}
    </span>
    ...
    {change && (
     <div className={`mt-1 flex items-center justify-end gap-1 text-[11px] font-bold ${isPositive ? "text-green-500" : "text-red-500"} tracking-tight`}>
