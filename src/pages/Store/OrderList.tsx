          ...
          {orders.map((order) => (
            <tr key={order.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors group">
             <td className="px-6 py-5">
               <span className="text-sm font-bold text-brand-500 ">#{order.id}</span>
             </td>
             <td className="px-6 py-5">
               <p className="text-sm font-bold text-gray-900 dark:text-white tracking-tight">{order.customer}</p>
             </td>
             <td className="px-6 py-5">
             ...
             <td className="px-6 py-5">
               <span className={`px-4 py-1.5 rounded-full text-[10px] font-bold  ${getStatusStyle(order.status)} underline decoration-2 underline-offset-4`}>
                {order.status}
               </span>
             </td>
             <td className="px-6 py-5">
               <span className="text-sm font-bold text-gray-900 dark:text-white ">${order.total} AUD</span>
             </td>
             <td className="px-6 py-5">
