      ...
      <div className="space-y-6 max-w-full mx-auto p-4 sm:p-6 lg:p-8">
       ...
       />
          ...
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 text-xs font-bold text-gray-500 hover:text-error-500 transition-all shadow-sm active:scale-95">
              Reject Application
            </button>
            <Button className="rounded-2xl px-12 font-bold shadow-xl shadow-brand-500/20 active:scale-95 transition-all text-sm">
              Approve Player
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                ...
                <div className="flex-1 text-center md:text-left">
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-2">
                    <h3 className="text-3xl font-bold  text-gray-900 dark:text-white-80 tracking-tight">{playerData.player.name}</h3>
                    <Badge color="info" className=" font-bold text-[10px] px-3">Age: {playerData.player.age}</Badge>
                    <Badge color="success" className=" font-bold text-[10px] px-3">Level: Elite</Badge>
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-transparent hover:border-brand-500/20 transition-all">
                      <span className="block text-[10px] font-bold text-gray-400 mb-1">Position</span>
                      <span className="text-xs font-bold  text-gray-800 dark:text-gray-200">{playerData.player.position}</span>
                    </div>
                    <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-transparent hover:border-brand-500/20 transition-all">
                      <span className="block text-[10px] font-bold text-gray-400 mb-1">Preferred Foot</span>
                      <span className="text-xs font-bold  text-gray-800 dark:text-gray-200">{playerData.player.preferredFoot}</span>
                    </div>
                    <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-transparent hover:border-brand-500/20 transition-all">
                      <span className="block text-[10px] font-bold text-gray-400 mb-1">Height</span>
                      <span className="text-xs font-bold  text-gray-800 dark:text-gray-200">{playerData.player.height}</span>
                    </div>
                    <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-transparent hover:border-brand-500/20 transition-all">
                      <span className="block text-[10px] font-bold text-gray-400 mb-1">Weight</span>
                      <span className="text-xs font-bold  text-gray-800 dark:text-gray-200">{playerData.player.weight}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm p-8">
              <h4 className="text-sm font-bold  text-gray-900 dark:text-white mb-6 border-l-4 border-brand-500 pl-3">Application Message</h4>
              <div className="p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                "{playerData.enquiry.message}"
              </div>

              <div className="mt-8">
                <h4 className="text-sm font-bold  text-gray-900 dark:text-white mb-6 border-l-4 border-brand-500 pl-3">Previous Clubs / Experience</h4>
                  ...
                  {playerData.experience.map((exp, index) => (
                    <div key={index} className="flex items-center gap-4 p-4 rounded-2xl border border-gray-50 dark:border-gray-800 hover:border-brand-500/20 transition-all">
                      ...
                      <div className="flex-1">
                        <h5 className="text-sm font-bold  text-gray-800 dark:text-gray-200">{exp.club}</h5>
                        <p className="text-[10px] font-bold text-gray-400 ">{exp.role}</p>
                      </div>
                      <span className="text-xs font-bold text-brand-500 ">{exp.years}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
              <h4 className="text-sm font-bold  text-gray-900 dark:text-white mb-6 border-l-4 border-brand-500 pl-3">Contact Identity</h4>
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-transparent flex items-center gap-4 group cursor-default">
                  ...
                  <div>
                    <span className="block text-[9px] font-bold  text-gray-400">Email Address</span>
                    <span className="text-xs font-bold  text-gray-800 dark:text-gray-300 truncate max-w-[180px]">{playerData.player.email}</span>
                  </div>
                </div>
                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-transparent flex items-center gap-4 group cursor-default">
                  <div className="w-10 h-10 bg-white dark:bg-gray-900 rounded-xl flex items-center justify-center text-brand-500 shadow-sm">
                  ...
                  <div>
                    <span className="block text-[9px] font-bold  text-gray-400">Phone Number</span>
                    <span className="text-xs font-bold  text-gray-800 dark:text-gray-300">{playerData.player.phone}</span>
                  </div>
                </div>
                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-transparent flex items-center gap-4 group cursor-default">
                  <div className="w-10 h-10 bg-white dark:bg-gray-900 rounded-xl flex items-center justify-center text-brand-500 shadow-sm">
                  ...
                  <div>
                    <span className="block text-[9px] font-bold  text-gray-400">Nationality</span>
                    <span className="text-xs font-bold  text-gray-800 dark:text-gray-300">{playerData.player.nationality}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-brand-600 rounded-3xl shadow-xl shadow-brand-500/30 p-8 text-white relative overflow-hidden">
              <div className="relative z-10">
                <span className="text-[10px] font-bold tracking-[0.2em] opacity-70">Enquiry Target</span>
                <h4 className="text-xl font-bold  mt-1 mb-6">{playerData.enquiry.team}</h4>
                ...
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <span className="block text-[9px] font-bold  opacity-70">Enquiry Date</span>
                    <span className="text-sm font-bold leading-none">{playerData.date}</span>
                  </div>
                </div>

                <button className="w-full py-4 bg-white text-brand-600 rounded-2xl text-xs font-bold  tracking-[0.1em] shadow-xl active:scale-95 transition-all flex items-center justify-center gap-2">
