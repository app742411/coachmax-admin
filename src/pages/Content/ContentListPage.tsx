        ...
        <div className="flex items-center gap-6 overflow-x-auto no-scrollbar pb-2">
           {tabs.map((tab) => (
             <button
               ...
               className={`text-sm font-black uppercase tracking-widest whitespace-nowrap transition-all border-b-2 pb-2 ${
                 activeTab === tab
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           ...
           <div className="lg:col-span-8 space-y-8">
                ...
                <div className="relative h-[480px] rounded-3xl overflow-hidden group shadow-2xl">
                   ...
                   <div className="absolute bottom-10 left-10 right-10">
                      <div className="flex items-center gap-3 mb-4">
                         <span className="bg-brand-500 text-white px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest italic shadow-lg">
                           {featured.category}
                         </span>
                      ...
                      <h2 className="text-4xl font-black text-white italic leading-tight mb-4 drop-shadow-md lg:w-3/4">
                         {featured.title}
                      </h2>
                      <div className="flex items-center justify-between">
                         <span className="text-white/60 text-xs font-bold uppercase tracking-widest italic">{featured.timeAgo}</span>
              ...
              <div className="space-y-4">
                 <h3 className="text-xs font-black text-gray-400 uppercase tracking-widest italic mb-6">Latest Feed</h3>
                 {items.map(item => (
                      ...
                      <div className="flex-1 min-w-0 py-1 flex flex-col justify-between">
                         <div>
                            <div className="flex items-center gap-3 mb-2">
                               <span className="text-[10px] font-black uppercase text-brand-500 tracking-wider underline underline-offset-4 decoration-2">
                                 {item.category}
                               </span>
                               <span className="text-[10px] text-gray-400 font-bold uppercase italic tracking-widest">
                                 {item.readTime}
                               </span>
                            </div>
                            <h4 className="text-lg font-black text-gray-900 dark:text-white mb-2 line-clamp-2 leading-snug">
                               {item.title}
                            </h4>
                         </div>
                         <div className="flex items-center justify-between mt-auto">
                            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{item.timeAgo}</span>
           ...
           <div className="lg:col-span-4 space-y-8">
              <div className="bg-white dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm">
                 <div className="flex items-center justify-between mb-6">
                    <h5 className="text-xs font-black text-gray-900 dark:text-white uppercase italic tracking-widest">Trending Topics</h5>
                    ...
                    {["Champions League", "Transfer Rumors", "Training Drills", "Premier League Insights", "Youth Academy"].map((topic, i) => (
                      <div key={i} className="flex items-center justify-between group cursor-pointer border-b border-gray-50 dark:border-gray-800 pb-3 last:border-0 last:pb-0">
                         <div className="flex items-center gap-3">
                            <span className="text-xl font-black text-gray-100 dark:text-gray-800 italic">{i+1}</span>
                         ...
                         <span className="text-[10px] font-black italic text-brand-500">2.1k</span>
                      </div>
                    ))}
                 </div>
              </div>
              ...
              <div className="p-8 bg-brand-500 rounded-3xl shadow-2xl relative overflow-hidden group">
                 ...
                 <h4 className="text-xl font-black text-white italic mb-4 relative z-10 leading-tight">Grow Your Audience with Quality Analysis</h4>
                 ...
                 <Button className="w-full bg-white text-brand-500 hover:bg-white/90 rounded-2xl font-black uppercase italic shadow-lg relative z-10 active:scale-95 transition-all py-4">Draft Post</Button>
              </div>
           </div>
        </div>
      </div>
